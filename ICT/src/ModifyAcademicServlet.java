...
@WebServlet(name = "ModifyAcademicServlet")
public class ModifyAcademicServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String AcadExp = request.getParameter("academic");
            String AcadExps[] = AcadExp.split("\n");
            String sql = "delete from acad_exp where staff_id = " + request.getParameter("sid") + "";
            stm.execute(sql);
