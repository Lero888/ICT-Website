...
<body>
	...
	<%
		...
		String sql = "select news.title as title, news.content as content, news.datacreated as date, news.thumbnail as image\n" +
				"from news\n" +
				"where idnews = '"+ nid +"'";
	...
	<form id = "submit_form" action="./AddNewsServlet" method="post">
		<div class = "flexcontainer">
			<div class="flexbox">
				<div class="col" style = "margin-top: 16px;">
					<input type="text" name="title" placeholder="Title" style = "width: 145px;">
				</div>
			...
			<div class="flexbox">
				<div class="col">
						<textarea name=content" style="width:100%; height:150px; margin-top: 16px;">
						</textarea>
				</div>
		...
		<div class = flexcontainer>
			<div class="flexbox">
				<div class="col">
					<input type="file" name="pic" accept="image/*"  style = "padding-top: 30px; text-align: left;">
				</div>
			</div>
