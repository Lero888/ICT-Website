                ...
                <div class = "infocontainer">
                    ...
                    <div class = "infobox" style = "background-color: #F5F5F5">
                        <div class = "column" style = "flex: 8.5;">
                            <form action = "./ModifyEmailServlet?sid=<%=request.getParameter("sid")%>" method = "post">
                                <input type="email" name="email" value="<%=bean.getEmail()%>" placeholder="Email" required> <br></br>
