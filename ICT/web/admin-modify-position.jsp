        ...
        <div class="flexbox">
            <div class="col">
                ...
                <div class = "infocontainer">
                    ...
                    <form action = "./ModifyPositionServlet?sid=<%=request.getParameter("sid")%>" method = "post">
                        <div class = "infobox" style = "background-color: #F5F5F5">
                            <div class = "column" style = "flex: 8.5;">
                                    <input type="text" name="position" value="<%=bean.getPosition()%>" placeholder="Position" required> <br></br>
